...
private func nexorgramSettingsMenuIcon() -> UIImage? {
    let bundle = Bundle.main
    let candidates: [(String, String)] = [
        ("NexorgramIcon@2x", "png"),
        ("NexorgramIcon@3x", "png"),
        ("GhostIcon@60x60", "png"),
        ("GhostIcon@58x58", "png")
    ]
    ...
    return PresentationResourcesSettings.nexorgram
}
...
//            }))
        ...
        items[.myProfile]!.append(PeerInfoScreenDisclosureItem(id: 1001, text: "Nexorgram Settings", icon: nexorgramSettingsMenuIcon(), action: {
            interaction.openSettings(.nexorgram)
        }))
